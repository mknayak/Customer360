...
TOOL_CATALOG: tuple[ToolContract, ...] = (
    ...
    ToolContract("graph.search", "Search approved entity relationships.", "graph", _schema("query", query="string")),
    ToolContract("graph.neighbors", "Retrieve approved entity neighbors.", "graph", _schema("entity_type", "entity_id", entity_type="string", entity_id="string")),
    ToolContract("graph.paths", "Find an approved relationship path.", "graph", _schema("from_id", "to_id", from_id="string", to_id="string")),
